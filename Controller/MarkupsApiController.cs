...
namespace SupplierDashboard.Controllers.Api
{
        ...
        public async Task<ActionResult<IEnumerable<MarkupSummaryDto>>> GetMarkups()
        {
            return await _context.Markups
                ...
                .Select(m => new MarkupSummaryDto
                {
                    ...
                    SubAgencyNames = m.MarkupAgencies.Select(ma => ma.SubAgency.AgencyName).ToList()
                })
        ...
        public async Task<ActionResult<MarkupDto>> GetMarkup(string id)
        {
            var markup = await _context.Markups
                ...
                .Select(m => new MarkupDto
                {
                    ...
                    IsActive = m.IsActive,
                    CreatedAt = m.CreatedAt,
                    SubAgencies = m.MarkupAgencies.Select(ma => new SubAgencyDto
                    {
                        Id = ma.SubAgency.Id,
                        AgencyName = ma.SubAgency.AgencyName,
                        Email = ma.SubAgency.Email,
                        Address = ma.SubAgency.Address,
                        CreatedAt = ma.SubAgency.CreatedAt
                    }).ToList()
                })
                .FirstOrDefaultAsync();
        ...
        public async Task<ActionResult<MarkupDto>> PostMarkup(CreateUpdateMarkupDto dto)
        {
            ...
            try
            {
                ...
                var result = new MarkupDto
                {
                    ...
                    SubAgencies = existingAgencies.Select(a => new SubAgencyDto
                    {
                        Id = a.Id,
    ...
    public class MarkupDto
    {
        ...
        public List<SubAgencyDto> SubAgencies { get; set; } = new List<SubAgencyDto>();
    }
