    ...
    public class UsersController : ControllerBase
    {
            ...
            try
            {
                var users = await _context.Users
                    ...
                    .Select(u => new UserDto
                    {
                        ...
                        AgencyId = u.AgencyId,
                        AgencyName = u.SubAgency != null ? u.SubAgency.AgencyName : null,
        ...
        public async Task<ActionResult<User>> CreateUser(CreateUserDto dto)
        {
            try
            {
                ...
                {
                    var agencyExists = await _context.SubAgencies.AnyAsync(a => a.Id == dto.AgencyId);
                    if (!agencyExists)
                    {
