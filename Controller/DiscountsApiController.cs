        ...
        public async Task<ActionResult<IEnumerable<DiscountSummaryDto>>> GetDiscounts()
        {
            return await _context.Discounts
                ...
                .Select(d => new DiscountSummaryDto
                {
                    ...
                    SubAgencyNames = d.DiscountAgencies.Select(da => da.SubAgency.AgencyName).ToList()
                })
        ...
        public async Task<ActionResult<DiscountDto>> GetDiscount(string id)
        {
            var discount = await _context.Discounts
                ...
                .Select(d => new DiscountDto
                {
                    ...
                    IsActive = d.IsActive,
                    CreatedAt = d.CreatedAt,
                    Agencies = d.DiscountAgencies.Select(da => new SubAgencyDto
                    {
                        Id = da.SubAgency.Id,
                        AgencyName = da.SubAgency.AgencyName,
                        Email = da.SubAgency.Email,
                        Address = da.SubAgency.Address,
                        CreatedAt = da.SubAgency.CreatedAt
                    }).ToList()
                })
                .FirstOrDefaultAsync();
