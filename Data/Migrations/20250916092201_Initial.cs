        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Agents_SubAgencies_AgencyId",
                        column: x => x.AgencyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubAgencyId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SubAgencies_SubAgencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountAgencies_SubAgencies_SubAgencyId",
                        column: x => x.SubAgencyId,
                        principalTable: "SubAgencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MarkupAgencies_SubAgencies_SubAgencyId",
                        column: x => x.SubAgencyId,
                        principalTable: "SubAgencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VoidServiceAgencies_SubAgencies_SubAgencyId",
                        column: x => x.SubAgencyId,
                        principalTable: "SubAgencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountAgencies_SubAgencyId",
                table: "DiscountAgencies",
                column: "SubAgencyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarkupAgencies_SubAgencyId",
                table: "MarkupAgencies",
                column: "SubAgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_VoidServiceAgencies_SubAgencyId",
